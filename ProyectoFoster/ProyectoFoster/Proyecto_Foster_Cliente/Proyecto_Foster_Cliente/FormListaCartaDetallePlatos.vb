Public Class FormListaCartaDetallePlatos
    ...
    Private Sub pbCambiarComensal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pbCambiarComensal.Click
